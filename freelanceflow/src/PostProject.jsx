...
// import { FaPlus, FaPaperPlane, FaEye, FaCheck, FaTimes, FaChartBar, FaBell, FaComments, FaClock, FaComment } from "react-icons/fa";
...
//   /* 🔥 FIXED SOCKET.IO - CORRECT EVENT NAMES */
//   useEffect(() => {
//     console.log("🔥 Client: Joining as 'client'...");
    
//     socket.emit("join", { role: "client" });
    
//     // ✅ FIXED: Correct socket events (matches server.js)
...
//     // ✅ NEW: Project posting feedback
//     socket.on("project-posted", ({ success, project }) => {
//       if (success) {
//         console.log("✅ Project posted:", project._id);
//         setPostedProjects(prev => [project, ...prev]);
//       } else {
...
//   /* 🔥 FIXED: REAL PROJECT POSTING (No fake ID) */
...
//       socket.emit("post-project", newProject);  // Backend saves to DB
//     }
...
//               <div 
//                 key={p._id} 
//                 className={`project-card ${p.status === 'accepted' ? 'accepted' : 'open'}`}
//               >
...
// import axios from "axios";
// import ChatModel from "./ChatModel";
// import { FaPlus, FaPaperPlane, FaEye, FaCheck, FaTimes, FaChartBar, FaBell, FaComments, FaClock, FaComment, FaDownload, FaFolderOpen, FaFileAlt } from "react-icons/fa";
// import "./PostProject.css";
...
//   const [notifications, setNotifications] = useState([]);
//   const [showChat, setShowChat] = useState(null);
//   const [showFiles, setShowFiles] = useState(null); // 🔥 NEW: File viewer
